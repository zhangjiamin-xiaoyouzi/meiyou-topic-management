...
outpath = r'c:\Users\MeetYou\vscode-workspace\赠礼详情页\交互流程图-赠礼详情页.html'
...
.branch-section {{ margin-top: 12px; }}
.branch-label-row {{ text-align: center; margin-bottom: 8px; }}
...
<div><div class="step-title">确认地址浮层</div><div class="step-op">底部弹出半屏面板，确认收货地址</div></div>
</div>
...
<div><div class="step-title">地址选择页（独立页面）</div><div class="step-op">选择地址后自动返回确认浮层</div></div>
</div>
...
<div class="step-desc">💡 「免费领取」变为灰色「已领取」；展示收货人+地址；物流区显示「等待发货」</div>
</div>
</div>
